...
std_color = {
    ...
    "Yellow": printYellow,
    "White": printWhite,
    "WhiteBlack": printWhiteBlack,
    "WhiteBlack2": printWhiteBlack_2,
    "YellowRed": printYellowRed,
}


def printColorIdx(mess, idx):

    if idx in std_color:
        std_color[idx](mess)
    else:
        std_color["YellowRed"](mess)
